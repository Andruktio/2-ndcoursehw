...
function changeColor() {
    var changerAbout = document.getElementById('games');
    var changerGames = document.getElementById('about-games')
    let newColor = getRandomColor();
    changerAbout.style.backgroundColor = newColor;
    changerGames.style.backgroundColor = newColor;
}
